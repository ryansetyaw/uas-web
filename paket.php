	...
	<div class="col-list-3">
		<div class="recent-car-list">
			...
			<div class="car-title-m">
				<h6 style="font-size:25px; padding-bottom: 10px"><a  href="paket_detail.php?id=<?php echo htmlentities($results['id_paket']);?>" align='center'><?php echo htmlentities($results['nama_paket']);?></a></h6>
